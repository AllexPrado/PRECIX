...
//------------------------------------------------------  
	addTileLayers: function() {
		...
		switch(this.options.provider){		
			case 1:  //Net:CloudMade   
				this.options.tileLayers[0] = L.tileLayer(this.getURL(1),this.mandatoryTileOptions(1,this.options.tileOptions)).addTo(this.options.mapId);	
			...
			case 45: //Net:Esri:NatGeoWorldMap 
				...
				this.options.controller = L.control.layers(this.options.baseMaps,this.options.overlays).addTo(this.options.mapId);
				break;
			case 51: //Net:Nokia:NormalDay     
			case 52: //Net:Nokia:NormalGreyDay 
			case 53: //Net:Nokia:SatelliteNoLabelsDay 
			case 54: //Net:Nokia:SatelliteYesLabelsDay
			case 55: //Net:Nokia:TerrainDay           
...
//------------------------------------------------------
	mandatoryTileOptions: function(p,options) {           	
		switch(p){		
			case 1:  //Net:CloudMade   
				options.attribution='Map data &copy; <a href="http://openstreetmap.org">OpenStreetMap</a> contributors, <a href="http://creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA</a>, Imagery © <a href="http://cloudmade.com">CloudMade</a>';
				break;
			case 11: //Net:MapBox                     
			...
			case 54: //Net:Nokia:SatelliteYesLabelsDay
			case 55: //Net:Nokia:TerrainDay           
				options.attribution='Map &copy; <a href="http://developer.here.com">Nokia</a>, Data &copy; NAVTEQ 2012';
				options.subdomains="1234";
				break;
			default:
				options.attribution='Tiles Courtesy of <a href="http://www.mapquest.com/">MapQuest</a> &mdash; Map data &copy; <a href="http://openstreetmap.org">OpenStreetMap</a> contributors, <a href="http://creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA</a>';
...
//------------------------------------------------------  
	getURL: function(p) {
		...
		switch(p){		
			case 1:  //Net:CloudMade                   
				return(h+'{s}.tile.cloudmade.com/{devID}/997/256/{z}/{x}/{y}.png')
			case 11: //Net:MapBox                     
			...
			case 51: //Net:Nokia:NormalDay     
				return(h+'{s}.maptile.lbs.ovi.com/maptiler/v2/maptile/newest/normal.day/{z}/{x}/{y}/256/png8?token={devID}&app_id={appID}')
			case 52: //Net:Nokia:NormalGreyDay 
				return(h+'{s}.maptile.lbs.ovi.com/maptiler/v2/maptile/newest/normal.day.grey/{z}/{x}/{y}/256/png8?token={devID}&app_id={appID}')
			case 53: //Net:Nokia:SatelliteNoLabelsDay 
				return(h+'{s}.maptile.lbs.ovi.com/maptiler/v2/maptile/newest/satellite.day/{z}/{x}/{y}/256/png8?token={devID}&app_id={appID}')
			case 54: //Net:Nokia:SatelliteYesLabelsDay
				return(h+'{s}.maptile.lbs.ovi.com/maptiler/v2/maptile/newest/hybrid.day/{z}/{x}/{y}/256/png8?token={devID}&app_id={appID}')	
			case 55: //Net:Nokia:TerrainDay           
				return(h+'{s}.maptile.lbs.ovi.com/maptiler/v2/maptile/newest/terrain.day/{z}/{x}/{y}/256/png8?token={devID}&app_id={appID}')
			default:
				return(h+'otile{s}.mqcdn.com/tiles/1.0.0/map/{z}/{x}/{y}.jpeg')
		}
	},
